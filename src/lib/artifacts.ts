...
const vendorProvenance = (slug: string): ArtifactProvenance => ({
  origin: 'upstream-oss',
  sourceUrl: `${UPSTREAM_REPO}/blob/${UPSTREAM_COMMIT}/design-md/${slug}/DESIGN.md`,
  repository: UPSTREAM_REPO,
  license: 'MIT',
  evidenceUrl: `${UPSTREAM_REPO}/blob/${UPSTREAM_COMMIT}/LICENSE`,
