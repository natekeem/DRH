...
function Footer(){return <footer className="site-footer"><div className="footer-brand"><b>DRH.</b><span>Design Reference Hub</span></div><div className="footer-copy"><p>좋은 것을 보고, 정확한 이름을 알고, 바로 가져다 쓰는 Visual Reference Library.</p><small>Source와 License를 숨기지 않고 Reference별로 함께 기록합니다.</small></div><div className="footer-links"><a href="#/explore">Explore</a><a href="#/guides">Guides</a><a href="#/sources">Sources</a><a href="https://github.com/natekeem/DRH" target="_blank" rel="noreferrer">GitHub</a></div></footer>}
