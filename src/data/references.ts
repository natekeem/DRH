...
export const references: ReferenceItem[] = [
  ...
  mk({ id:'liquid-lens-effect', name:'Liquid Lens', category:'Effects', subcategory:'Pointer', demo:'liquid-refraction', description:'A pointer-following lens magnifies and distorts the content beneath it.', tags:['lens','liquid','cursor'], useCases:['hero','gallery','showcase'], featured:true, wow:true }),
