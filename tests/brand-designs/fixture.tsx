...
import './fixture.css'
const canaries=new URLSearchParams(location.search).get('slugs')?.split(',')||["apple","airbnb","notion","linear.app","stripe","vercel","spotify","ferrari","nintendo-2001","binance","tesla","figma","ibm","supabase"]
