...
| Liquid Glass (liquid-glass) | 구체적 | 효과별 | 실행 HTML | Hub Original | https://github.com/natekeem/DRH/blob/main/LICENSE | Ready |
| Bento Grid (bento) | 기본/부분 | 미완성 | 없음 | Hub Original | https://github.com/natekeem/DRH/blob/main/LICENSE | Partial |
| Editorial (editorial) | 기본/부분 | 미완성 | 없음 | Hub Original | https://github.com/natekeem/DRH/blob/main/LICENSE | Partial |
| Swiss / International (swiss) | 기본/부분 | 미완성 | 없음 | Hub Original | https://github.com/natekeem/DRH/blob/main/LICENSE | Partial |
...
| Shader Gradient (shader-gradient) | 구체적 | 효과별 | 실행 TSX | https://shadergradient.co/ | https://github.com/ruucm/shadergradient/blob/main/packages/shadergradient/package.json | Ready |
| Aurora Background (aurora-background) | 구체적 | 효과별 | 실행 HTML | Hub Original | https://github.com/natekeem/DRH/blob/main/LICENSE | Ready |
| Animated Gradient Mesh (gradient-mesh) | 구체적 | 효과별 | 실행 HTML | Hub Original | https://github.com/natekeem/DRH/blob/main/LICENSE | Ready |
| Interactive Particles (particles) | 구체적 | 효과별 | 실행 HTML | https://particles.js.org/ | https://github.com/tsparticles/tsparticles/blob/main/LICENSE | Ready |
| Meteors (meteors) | 구체적 | 효과별 | 실행 HTML | https://magicui.design/ | https://github.com/magicuidesign/magicui/blob/main/LICENSE.md | Ready |
| Interactive Dot Grid (dot-grid) | 구체적 | 효과별 | 실행 HTML | Hub Original | https://github.com/natekeem/DRH/blob/main/LICENSE | Ready |
| Retro Perspective Grid (retro-grid) | 구체적 | 효과별 | 실행 HTML | Hub Original | https://github.com/natekeem/DRH/blob/main/LICENSE | Ready |
| Pointer Spotlight (spotlight-background) | 구체적 | 효과별 | 실행 HTML | Hub Original | https://github.com/natekeem/DRH/blob/main/LICENSE | Ready |
| Light Beams (beams) | 구체적 | 효과별 | 실행 HTML | Hub Original | https://github.com/natekeem/DRH/blob/main/LICENSE | Ready |
| Wave Lines (wave-lines) | 구체적 | 효과별 | 실행 HTML | Hub Original | https://github.com/natekeem/DRH/blob/main/LICENSE | Ready |
| Noise Blobs (noise-blobs) | 구체적 | 효과별 | 실행 HTML | Hub Original | https://github.com/natekeem/DRH/blob/main/LICENSE | Ready |
| Fluid Cursor Field (fluid-cursor) | 구체적 | 미완성 | 실행 HTML | Hub Original | https://github.com/natekeem/DRH/blob/main/LICENSE | Ready |
| Interactive Metaballs (metaballs) | 구체적 | 미완성 | 실행 HTML | Hub Original | https://github.com/natekeem/DRH/blob/main/LICENSE | Ready |
| Starfield (starfield) | 구체적 | 효과별 | 실행 HTML | Hub Original | https://github.com/natekeem/DRH/blob/main/LICENSE | Ready |
...
| Hover Lift (hover-lift) | 구체적 | 효과별 | 실행 HTML | Hub Original | https://github.com/natekeem/DRH/blob/main/LICENSE | Ready |
| Magnetic Button (magnetic-button) | 구체적 | 효과별 | 실행 HTML | Hub Original | https://github.com/natekeem/DRH/blob/main/LICENSE | Ready |
| Card Tilt (card-tilt) | 구체적 | 효과별 | 실행 HTML | https://micku7zu.github.io/vanilla-tilt.js/ | https://github.com/micku7zu/vanilla-tilt.js/blob/master/LICENSE | Ready |
| Cursor Image Trail (image-trail) | 구체적 | 효과별 | 실행 HTML | Hub Original | https://github.com/natekeem/DRH/blob/main/LICENSE | Ready |
| Infinite Marquee (marquee) | 구체적 | 효과별 | 실행 HTML | Hub Original | https://github.com/natekeem/DRH/blob/main/LICENSE | Ready |
| Sticky Scroll Story (sticky-story) | 구체적 | 효과별 | 실행 HTML | Hub Original | https://github.com/natekeem/DRH/blob/main/LICENSE | Ready |
...
| Blur Reveal (blur-reveal) | 구체적 | 효과별 | 실행 HTML | Hub Original | https://github.com/natekeem/DRH/blob/main/LICENSE | Ready |
| Split Text (split-text) | 구체적 | 효과별 | 실행 HTML | https://splitting.js.org/ | https://github.com/shshaw/Splitting/blob/master/LICENSE.md | Ready |
| Gradient Text (gradient-text) | 구체적 | 효과별 | 실행 HTML | Hub Original | https://github.com/natekeem/DRH/blob/main/LICENSE | Ready |
| Shimmer Text (shimmer-text) | 구체적 | 효과별 | 실행 HTML | Hub Original | https://github.com/natekeem/DRH/blob/main/LICENSE | Ready |
| Scramble Text (scramble-text) | 구체적 | 효과별 | 실행 HTML | Hub Original | https://github.com/natekeem/DRH/blob/main/LICENSE | Ready |
| Rotating Words (rotating-words) | 구체적 | 효과별 | 실행 HTML | Hub Original | https://github.com/natekeem/DRH/blob/main/LICENSE | Ready |
| Number Ticker (number-ticker) | 구체적 | 효과별 | 실행 HTML | Hub Original | https://github.com/natekeem/DRH/blob/main/LICENSE | Ready |
| Hand-drawn Highlight (highlight-animation) | 기본/부분 | 미완성 | 없음 | https://roughnotation.com/ | https://github.com/rough-stuff/rough-notation/blob/master/LICENSE | Partial |
| Glass Card (glass-card) | 구체적 | 효과별 | 실행 HTML | Hub Original | https://github.com/natekeem/DRH/blob/main/LICENSE | Ready |
| Glow Card (glow-card) | 구체적 | 효과별 | 실행 HTML | Hub Original | https://github.com/natekeem/DRH/blob/main/LICENSE | Ready |
...
| Pricing Cards (pricing-section) | 기본/부분 | 미완성 | 없음 | Hub Original | https://github.com/natekeem/DRH/blob/main/LICENSE | Partial |
| Testimonials (testimonials-section) | 기본/부분 | 미완성 | 없음 | Hub Original | https://github.com/natekeem/DRH/blob/main/LICENSE | Partial |
| Feature Comparison (comparison-section) | 기본/부분 | 미완성 | 없음 | Hub Original | https://github.com/natekeem/DRH/blob/main/LICENSE | Partial |
...
| Documentation (docs-page) | 기본/부분 | 미완성 | 없음 | Hub Original | https://github.com/natekeem/DRH/blob/main/LICENSE | Partial |
| Portfolio (portfolio-page) | 기본/부분 | 미완성 | 없음 | Hub Original | https://github.com/natekeem/DRH/blob/main/LICENSE | Partial |
| Explainer / Education (education-page) | 기본/부분 | 미완성 | 없음 | Hub Original | https://github.com/natekeem/DRH/blob/main/LICENSE | Partial |
| Internal Admin (admin-page) | 기본/부분 | 미완성 | 없음 | Hub Original | https://github.com/natekeem/DRH/blob/main/LICENSE | Partial |
| Login / Signup (login-page) | 기본/부분 | 미완성 | 없음 | Hub Original | https://github.com/natekeem/DRH/blob/main/LICENSE | Partial |
| Event Landing (event-page) | 기본/부분 | 미완성 | 없음 | Hub Original | https://github.com/natekeem/DRH/blob/main/LICENSE | Partial |
| Minimal SaaS (minimal-saas) | 기본/부분 | 미완성 | DESIGN.md | Hub Original | https://github.com/natekeem/DRH/blob/main/LICENSE | Partial |
| Playful Neo-Brutalism (playful-brutal) | 기본/부분 | 미완성 | DESIGN.md | Hub Original | https://github.com/natekeem/DRH/blob/main/LICENSE | Partial |
| Editorial (editorial-system) | 기본/부분 | 미완성 | DESIGN.md | Hub Original | https://github.com/natekeem/DRH/blob/main/LICENSE | Partial |
| Developer Tool (developer-tool-system) | 기본/부분 | 미완성 | DESIGN.md | Hub Original | https://github.com/natekeem/DRH/blob/main/LICENSE | Partial |
| Corporate Dashboard (corporate-dashboard) | 기본/부분 | 미완성 | DESIGN.md | Hub Original | https://github.com/natekeem/DRH/blob/main/LICENSE | Partial |
| Luxury (luxury-system) | 기본/부분 | 미완성 | DESIGN.md | Hub Original | https://github.com/natekeem/DRH/blob/main/LICENSE | Partial |
| Documentation (docs-system) | 기본/부분 | 미완성 | DESIGN.md | Hub Original | https://github.com/natekeem/DRH/blob/main/LICENSE | Partial |
...
| Neumorphism / Soft UI (neumorphism) | 구체적 | 효과별 | 실행 HTML | https://github.com/AKAspanion/ui-neumorphism | https://github.com/natekeem/DRH/blob/main/LICENSE | Ready |
| Skeuomorphism (skeuomorphism) | 구체적 | 효과별 | 실행 HTML | https://github.com/KzqKzq/tactile-ui | https://github.com/natekeem/DRH/blob/main/LICENSE | Ready |
| Bauhaus (bauhaus) | 구체적 | 효과별 | 실행 HTML | https://lidge-jun.github.io/design-isms/ | https://github.com/natekeem/DRH/blob/main/LICENSE | Ready |
| Japandi (japandi) | 구체적 | 효과별 | 실행 HTML | https://www.framer.com/marketplace/templates/ | https://github.com/natekeem/DRH/blob/main/LICENSE | Ready |
| Bottom Sheet (bottom-sheet) | 구체적 | 효과별 | 실행 HTML | https://github.com/viliket/pure-web-bottom-sheet | https://github.com/natekeem/DRH/blob/main/LICENSE | Ready |
| Command Palette (command-palette) | 구체적 | 효과별 | 실행 HTML | https://github.com/starc007/ui-components/blob/main/AGENTS.md | https://github.com/natekeem/DRH/blob/main/LICENSE | Ready |
| Toast Notification (toast-notification) | 구체적 | 효과별 | 실행 HTML | https://github.com/timolins/react-hot-toast | https://github.com/natekeem/DRH/blob/main/LICENSE | Ready |
| Skeleton Loading (skeleton-loading) | 구체적 | 효과별 | 실행 HTML | https://github.com/dvtng/react-loading-skeleton | https://github.com/natekeem/DRH/blob/main/LICENSE | Ready |
| Segmented Control (segmented-control) | 구체적 | 효과별 | 실행 HTML | https://github.com/react-component/segmented | https://github.com/natekeem/DRH/blob/main/LICENSE | Ready |
| Agency Landing (agency-landing) | 구체적 | 효과별 | 실행 HTML | https://github.com/Shatlyk1011/agency-website | https://github.com/natekeem/DRH/blob/main/LICENSE | Ready |
...
| Cal.com (admd-cal) | 기본/부분 | 미완성 | 없음 | https://github.com/VoltAgent/awesome-design-md/tree/main/design-md/cal/DESIGN.md | undefined | Partial |
...
| Dell 1996 Inspired (admd-dell-1996) | 기본/부분 | 미완성 | 없음 | https://github.com/VoltAgent/awesome-design-md/tree/main/design-md/dell-1996/DESIGN.md | undefined | Partial |
...
| Linear (admd-linear.app) | 기본/부분 | 미완성 | 없음 | https://github.com/VoltAgent/awesome-design-md/tree/main/design-md/linear.app/DESIGN.md | undefined | Partial |
...
| Nintendo.com (2001) (admd-nintendo-2001) | 기본/부분 | 미완성 | 없음 | https://github.com/VoltAgent/awesome-design-md/tree/main/design-md/nintendo-2001/DESIGN.md | undefined | Partial |
...
| OpenCode (admd-opencode.ai) | 기본/부분 | 미완성 | 없음 | https://github.com/VoltAgent/awesome-design-md/tree/main/design-md/opencode.ai/DESIGN.md | undefined | Partial |
...
| Runway (admd-runwayml) | 기본/부분 | 미완성 | 없음 | https://github.com/VoltAgent/awesome-design-md/tree/main/design-md/runwayml/DESIGN.md | undefined | Partial |
...
| Sentri-Inspired (admd-sentry) | 기본/부분 | 미완성 | 없음 | https://github.com/VoltAgent/awesome-design-md/tree/main/design-md/sentry/DESIGN.md | undefined | Partial |
| Shopifi-Inspired (admd-shopify) | 기본/부분 | 미완성 | 없음 | https://github.com/VoltAgent/awesome-design-md/tree/main/design-md/shopify/DESIGN.md | undefined | Partial |
| Slacc-Inspired (admd-slack) | 기본/부분 | 미완성 | 없음 | https://github.com/VoltAgent/awesome-design-md/tree/main/design-md/slack/DESIGN.md | undefined | Partial |
| Spacex-Inspired (admd-spacex) | 기본/부분 | 미완성 | 없음 | https://github.com/VoltAgent/awesome-design-md/tree/main/design-md/spacex/DESIGN.md | undefined | Partial |
...
| Stripi-Inspired (admd-stripe) | 기본/부분 | 미완성 | 없음 | https://github.com/VoltAgent/awesome-design-md/tree/main/design-md/stripe/DESIGN.md | undefined | Partial |
| Supabaze-Inspired (admd-supabase) | 기본/부분 | 미완성 | 없음 | https://github.com/VoltAgent/awesome-design-md/tree/main/design-md/supabase/DESIGN.md | undefined | Partial |
| Superhumon-Inspired (admd-superhuman) | 기본/부분 | 미완성 | 없음 | https://github.com/VoltAgent/awesome-design-md/tree/main/design-md/superhuman/DESIGN.md | undefined | Partial |
...
| The Verge (admd-theverge) | 기본/부분 | 미완성 | 없음 | https://github.com/VoltAgent/awesome-design-md/tree/main/design-md/theverge/DESIGN.md | undefined | Partial |
| Together-AI-Inspired (admd-together.ai) | 기본/부분 | 미완성 | 없음 | https://github.com/VoltAgent/awesome-design-md/tree/main/design-md/together.ai/DESIGN.md | undefined | Partial |
| Uber-Inspired (admd-uber) | 기본/부분 | 미완성 | 없음 | https://github.com/VoltAgent/awesome-design-md/tree/main/design-md/uber/DESIGN.md | undefined | Partial |
| Vercel-Inspired (admd-vercel) | 기본/부분 | 미완성 | 없음 | https://github.com/VoltAgent/awesome-design-md/tree/main/design-md/vercel/DESIGN.md | undefined | Partial |
| Vodafone-Inspired (admd-vodafone) | 기본/부분 | 미완성 | 없음 | https://github.com/VoltAgent/awesome-design-md/tree/main/design-md/vodafone/DESIGN.md | undefined | Partial |
| Voltagent-Inspired (admd-voltagent) | 기본/부분 | 미완성 | 없음 | https://github.com/VoltAgent/awesome-design-md/tree/main/design-md/voltagent/DESIGN.md | undefined | Partial |
| Warp-Inspired (admd-warp) | 기본/부분 | 미완성 | 없음 | https://github.com/VoltAgent/awesome-design-md/tree/main/design-md/warp/DESIGN.md | undefined | Partial |
| Webflow-Inspired (admd-webflow) | 기본/부분 | 미완성 | 없음 | https://github.com/VoltAgent/awesome-design-md/tree/main/design-md/webflow/DESIGN.md | undefined | Partial |
| Wired-Inspired (admd-wired) | 기본/부분 | 미완성 | 없음 | https://github.com/VoltAgent/awesome-design-md/tree/main/design-md/wired/DESIGN.md | undefined | Partial |
| Wise-Inspired (admd-wise) | 기본/부분 | 미완성 | 없음 | https://github.com/VoltAgent/awesome-design-md/tree/main/design-md/wise/DESIGN.md | undefined | Partial |
| xAI-Inspired (admd-x.ai) | 기본/부분 | 미완성 | 없음 | https://github.com/VoltAgent/awesome-design-md/tree/main/design-md/x.ai/DESIGN.md | undefined | Partial |
| Zapier-Inspired (admd-zapier) | 기본/부분 | 미완성 | 없음 | https://github.com/VoltAgent/awesome-design-md/tree/main/design-md/zapier/DESIGN.md | undefined | Partial |
