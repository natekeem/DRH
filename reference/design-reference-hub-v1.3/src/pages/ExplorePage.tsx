...
export function ExplorePage(){
  ...
  return <main className="listing-page">
    ...
    <section className="listing-toolbar"><div className="demo-legend"><span><i className="maturity-official"/> OFFICIAL LIVE</span><span><i className="maturity-working"/> WORKING DEMO</span><span><i className="maturity-prototype"/> PROTOTYPE</span><span><i className="maturity-external"/> LINK ONLY</span></div>
